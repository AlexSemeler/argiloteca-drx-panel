...
Descrição:
Normalize locally downloaded AMCSD CIF/DIF files into Argiloteca JSONL.
...
from argiloteca_custom.scripts.open_patterns.fetch_open_patterns import normalize_amcsd_files
...
def main(argv=None):
    ...
    records = normalize_amcsd_files(args.out, load_argiloteca_vocabulary(vocab_path))
