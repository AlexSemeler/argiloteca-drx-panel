...
Descrição:
Normalize locally downloaded COD search/CIF files into Argiloteca JSONL.
...
from argiloteca_custom.scripts.open_patterns.fetch_open_patterns import normalize_cod_files
...
def main(argv=None):
    ...
    records = normalize_cod_files(args.out, load_argiloteca_vocabulary(vocab_path), simulate=args.simulate_cod_patterns)
