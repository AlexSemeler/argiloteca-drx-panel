...
# Módulo............: adapter_mixed_layer_rules_to_simulation.py
#
# Descrição.........:
...
def mixed_layer_candidate_to_parameters(candidate):
    """
    Executa a etapa `mixed_layer_candidate_to_parameters` do módulo.

        Args:
            candidate:
                Parâmetro utilizado pela etapa `mixed_layer_candidate_to_parameters`.
        Returns:
    ...
    """
    return {'Reichweite': (candidate or {}).get('ordering_estimate'), 'component_fraction': (candidate or {}).get('composition_estimate')}
