...
# Módulo............: adapter_peak_detection_to_simulation.py
#
# Descrição.........:
...
def peaks_to_observed_arrays(peaks):
    """
    Executa a etapa `peaks_to_observed_arrays` do módulo.

        Args:
            peaks:
                Parâmetro utilizado pela etapa `peaks_to_observed_arrays`.
        Returns:
    ...
    """
    return {'two_theta': [p.get('two_theta') for p in peaks or []], 'intensity': [p.get('i_abs', p.get('intensity', 0)) for p in peaks or []]}
