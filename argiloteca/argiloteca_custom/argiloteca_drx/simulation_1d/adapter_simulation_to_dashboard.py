...
# Módulo............: adapter_simulation_to_dashboard.py
#
# Descrição.........:
...
def simulation_to_dashboard(payload):
    """
    Executa a etapa `simulation_to_dashboard` do módulo.

        Args:
            payload:
                Parâmetro utilizado pela etapa `simulation_to_dashboard`.
        Returns:
    ...
    """
    return {'simulation_panel': payload}
