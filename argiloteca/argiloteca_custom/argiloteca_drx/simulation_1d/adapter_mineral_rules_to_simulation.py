...
# Módulo............: adapter_mineral_rules_to_simulation.py
#
# Descrição.........:
...
def candidate_to_model(candidate):
    """
    Executa a etapa `candidate_to_model` do módulo.

        Args:
            candidate:
                Parâmetro utilizado pela etapa `candidate_to_model`.
        Returns:
    ...
    """
    return {'candidate_model': (candidate or {}).get('label') or (candidate or {}).get('mineral') or 'unknown'}
