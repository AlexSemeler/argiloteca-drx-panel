...
# Módulo............: adapter_simulation_to_invenio.py
#
# Descrição.........:
...
def simulation_to_invenio(payload):
    """
    Executa a etapa `simulation_to_invenio` do módulo.

        Args:
            payload:
                Parâmetro utilizado pela etapa `simulation_to_invenio`.
        Returns:
    ...
    """
    return {'schema': 'argiloteca.xrd_1d_simulation.v1', 'metadata': payload}
