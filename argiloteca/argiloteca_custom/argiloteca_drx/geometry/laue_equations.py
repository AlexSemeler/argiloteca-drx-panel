...
def laue_integer(period_A: float, alpha_deg: float, alpha0_deg: float, lambda_A: float) -> float:
    """
    Executa a etapa `laue_integer` do módulo.

        Args:
            period_A:
                Parâmetro utilizado pela etapa `laue_integer`.
            alpha_deg:
                Parâmetro utilizado pela etapa `laue_integer`.
            alpha0_deg:
                Parâmetro utilizado pela etapa `laue_integer`.
    ...
    """
    return float(period_A) * (math.cos(math.radians(alpha_deg)) - math.cos(math.radians(alpha0_deg))) / float(lambda_A)
