...
def density_from_unit_cell(sum_atomic_weights: float, volume_A3: float) -> float:
    """Compute x-ray density using rho = 1.66042*sumA/V'."""
    return 1.66042 * float(sum_atomic_weights) / float(volume_A3)
